...
class _SelectionInputs:
    ...
    latest_monthly: dict[str, UsageHistory] = field(default_factory=dict)
...
class LoadBalancer:
    def __init__(self, repo_factory: ProxyRepoFactory | Callable[[], object]) -> None:
        self._repo_factory = cast(ProxyRepoFactory, repo_factory)
...
def _is_chatgpt_state_healthy_for_platform_fallback(
    ...
    *,
    ...
    return secondary_remaining is not None and primary_healthy and secondary_remaining > secondary_remaining_threshold
