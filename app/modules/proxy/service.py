...
from app.modules.proxy._service.api_key_usage import (
    _normalize_service_tier_value as _normalize_service_tier_value,
)
from app.modules.proxy._service.api_key_usage import (
...
from app.modules.proxy._service.http_bridge.helpers import (
    _http_bridge_can_single_instance_owner_takeover_without_anchor,  # noqa: F401
    _http_bridge_can_single_instance_prompt_cache_takeover_without_anchor,  # noqa: F401
...
from app.modules.proxy._service.platform import (
    ProviderSelectionFailure as ProviderSelectionFailure,
)
from app.modules.proxy._service.platform import (
    ProviderSelectionResult as ProviderSelectionResult,
)
from app.modules.proxy._service.platform import (
    SelectedChatGPTSubject as SelectedChatGPTSubject,
)
from app.modules.proxy._service.platform import (
    SelectedPlatformSubject as SelectedPlatformSubject,
)
from app.modules.proxy._service.platform import (
    _PlatformProviderMixin,
)
from app.modules.proxy._service.platform import (
    _SelectedPlatformIdentity as _SelectedPlatformIdentity,
)
...
from app.modules.proxy.affinity import (
    _is_synthesized_turn_state as _is_synthesized_turn_state,
)
from app.modules.proxy.affinity import (
    _owner_lookup_session_id_from_headers as _owner_lookup_session_id_from_headers,
)
from app.modules.proxy.affinity import (
    _resolve_prompt_cache_key as _resolve_prompt_cache_key,
)
from app.modules.proxy.affinity import (
...
from app.modules.proxy.affinity import (
    _sticky_key_from_turn_state_header as _sticky_key_from_turn_state_header,
)
from app.modules.proxy.affinity import (
...
from app.modules.proxy.platform_cache_alerts import (
    get_platform_cache_alert_service as get_platform_cache_alert_service,
)
...
from app.modules.proxy.provider_adapters import (
    RequestCapabilities as RequestCapabilities,
)
from app.modules.proxy.provider_adapters import (
    _platform_error_code as _platform_error_code,
)
from app.modules.proxy.provider_adapters import (
    _platform_error_message as _platform_error_message,
)
from app.modules.proxy.provider_adapters import (
...
async def core_compact_responses(*args: Any, **kwargs: Any) -> Any:
    func = _provider_adapters.core_compact_responses
